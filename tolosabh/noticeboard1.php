...
<header>
  ...
  <main>
    <section class="notice-board">
      ...
      <h3>NOTICE OF PAYMENT</h3>
      <div class="notice">
        <p>DUE DATE: February 12, 2025</p>
        <p>AMOUNT: $100</p>
        <p>NOTE: If rent is overdue, there is a penalty charge of $20</p>
      </div>
    </section>

    <section class="community-forum">
  <h2>APARTMENT COMMUNITY FORUM</h2>
  <p>Please state your feedback or issues here. Thank you!</p>
